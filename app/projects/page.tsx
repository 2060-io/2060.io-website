    ...
    <section id="verana" className="px-6 py-16 border-b hairline reveal scroll-mt-20">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-8 reading space-y-5 text-e5">
            <p>
              Verana is a neutral, decentralized Layer-1 protocol for trust registries, credential schemas, and verifiable governance. It is <strong className="text-fg">not</strong> a 2060 product. Its specifications are stewarded by the <a href="https://veranafoundation.org" className="prose-link text-fg" rel="noopener">Verana Foundation</a>, and the live network is governed and secured by the <a href="https://veranacouncil.org" className="prose-link text-fg" rel="noopener">Verana Council</a>, an independent association of member organizations across sectors and jurisdictions, each holding one vote.
            </p>
    ...
    <section id="specifications" className="px-6 py-16 border-b hairline reveal scroll-mt-20">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-8 reading space-y-5 text-e5">
            <p>
              The specifications that define the Verifiable Trust category. Public, openly licensed, maintained through the <a href="https://veranafoundation.org" className="prose-link text-fg" rel="noopener">Verana Foundation</a>'s editorial process with 2060 as lead author.
            </p>
