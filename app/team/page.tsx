        ...
        <div className="grid md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-8 reading">
            <ul className="space-y-4 text-muted">
              <li className="flex items-start gap-3"><i className="fa-solid fa-fw fa-star text-muted mt-1" aria-hidden="true"></i><span><a href="https://veranafoundation.org" className="prose-link text-fg" rel="noopener">Verana Foundation</a>: founding member, lead author of the Verifiable Trust and VPR specifications.</span></li>
              <li className="flex items-start gap-3"><i className="fa-solid fa-fw fa-landmark text-muted mt-1" aria-hidden="true"></i><span><a href="https://veranacouncil.org" className="prose-link text-fg" rel="noopener">Verana Council</a>: Council seat (25-member Council, in formation), validator operator on the Verana Trust Network.</span></li>
