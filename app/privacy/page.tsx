    ...
    <section className="px-6 py-16 border-b hairline reveal">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-12 gap-10 mt-10 border-t hairline pt-10">
          ...
          <div className="md:col-span-8 reading text-e5 space-y-5">
            <p className="text-muted"><strong className="text-fg">Google Analytics 4 (GA4).</strong> On your first visit the site shows a cookie dialog with two choices, <strong className="text-fg">OK</strong> or <strong className="text-fg">Cancel</strong>. The GA4 tag (measurement ID <code>G-9H5406F02W</code>) is loaded <strong className="text-fg">only if you click OK</strong>. If you click Cancel, or close the banner without choosing, no GA4 tag is injected and no analytics cookies are set. When GA4 is allowed it uses two first-party cookies to count pageviews and track navigation between pages:</p>
            <ul className="space-y-2 text-muted">
            ...
            <p className="text-muted"><strong className="text-fg">Remembering your choice.</strong> Your OK / Cancel answer is stored under the key <code>2060-cookie-consent</code> in your browser's <code>localStorage</code> so the banner does not reappear on every page. That entry is not a cookie, is not transmitted to any server, and is scoped to this origin only. Clearing site data for <code>2060.io</code> in your browser will reset the dialog on your next visit.</p>
            ...
            <p className="text-xs text-muted italic">Clicking <strong className="text-fg">Cancel</strong> in the banner is the simplest way to opt out. As a belt-and-braces alternative, browser-level blockers like uBlock Origin or the official <a href="https://tools.google.com/dlpage/gaoptout" className="prose-link text-fg" rel="noopener">Google Analytics Opt-out Browser Add-on</a> will also prevent the GA4 script from loading. We do not contest either choice and the site functions identically.</p>
          </div>
        </div>
      </div>
    </section>
